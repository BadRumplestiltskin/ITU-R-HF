...
static const struct RptCol RptCols[] = {
	...
	{ RPT_NOISESOURCESD,   "DuG - Upper decile deviation of galactic noise (dB)", "DuG", DBLFIELD, RFC4180_DBLFIELD, rget_DuG, NULL },
	{ RPT_NOISESOURCESD,   "DlG - Lower decile deviation of galactic noise (dB)", "DlG", DBLFIELD, RFC4180_DBLFIELD, rget_DlG, NULL },
